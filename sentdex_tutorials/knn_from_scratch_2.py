...
for i in range(25):
    ...
    for group in test_set:
        for data in test_set[group]:
            vote, confidence = k_nearset_neighbors(train_set, data, k=5)
            if group == vote:
                correct += 1
#            else:
#                print(confidence)
...
# KNN can give confidence
# Accuracy is 'did we get the classification right?', confidence can come from the classifier

# KNN can work on linear and non linear data
# regression requires linear data
